...
public class BasicPromo5 extends HelperClass{

	public void basicpromo5() throws Exception{
		...
		//	db.sysloginfo(log, "Click on OK");
			...
			//store attribute dropdown
			 ...
			 Segmenttt.click();
					...
					driver.findElement(By.xpath("//input[@placeholder='Enter Amount']")).sendKeys("2");
