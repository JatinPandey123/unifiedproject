...
//			element3.click();
			...
			Thread.sleep(1000);
		//	String code="BAT4";
			driver.findElement(By.xpath("//input[@id='catalogCode']")).sendKeys("Cosmetics"+date2);
			
			Thread.sleep(1000);
			driver.findElement(By.xpath("//input[@formcontrolname='catalogName']")).sendKeys("Cosmetics"+date2);
