...
//				element3.click();
	...
	//------------------------------------------Basic Information-----------------------------------------------------------------//
		...
		WebElement element = waitsss.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@class='mat-option-text'][contains(text(),'Catalog for Promotion Products')]")));
		element.click();
