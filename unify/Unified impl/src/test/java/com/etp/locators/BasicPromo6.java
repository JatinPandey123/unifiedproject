...
public class BasicPromo6 extends HelperClass{

	public void basicpromo6() throws Exception{
	...
	//		WebDriverWait waitss = new WebDriverWait(driver, 50);
		...
		//	WebDriverWait apply = new WebDriverWait(driver, 50);
			...
			WebElement element6 = wait.until(ExpectedConditions.visibilityOfElementLocated(
					By.xpath("//div[contains(text(),'Free Product Promotions')]")));
			element6.click();
...
//	   		}
		...
		//	db.sysloginfo(log, "Click on OK");
			...
			//product attributes
			 ...
			 WebElement Prodattr= driver.findElement(By.xpath("//*[@ng-reflect-name='productAttributes']"));
			 Prodattr.click();
				    List<WebElement> proatt = driver.findElements(By.tagName("mat-option"));
					 for(WebElement values:proatt)
					 {
					...
					//    WebDriverWait waitsw = new WebDriverWait(driver, 1000);
						WebElement element62 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@ng-reflect-name='productAttributesValue']")));
						element62.click();
...
//		
					...
					Thread.sleep(3000);
					driver.findElement(By.xpath("//input[@ng-reflect-id='searchItem']")).sendKeys("Product200");
					...
					driver.findElement(By.xpath("(//input[@placeholder='Search Product'])[4]")).sendKeys("2298222");
					
					Thread.sleep(1000);
					driver.findElement(By.xpath("//mat-option[@class='mat-option ng-star-inserted']")).click();
