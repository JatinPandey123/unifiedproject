...
//		element5.click();
	...
	//	driver.findElement(By.xpath("//li[contains(text(),' Bata QA ')]")).click();
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath("//input[@placeholder='Select Store']")).sendKeys("mum233");
		
		
		
		Thread.sleep(1000);
		driver.findElement(By.xpath("//span[contains(text(),' MUM232 - Mumbai Store 233 ')]")).click();
...
//				 }
	...
	public void fillcounterdetails() {
		...
		Thread.sleep(2000);
		driver.findElement(By.id("counterCode")).sendKeys("FG5"+date2);
		
		Thread.sleep(2000);
		driver.findElement(By.id("counterName")).sendKeys("CountFG5"+date2);
