...
public class BasicPromo7 extends HelperClass{

	public void basicpromo7() throws Exception{
...
//	   		}
		...
		//	db.sysloginfo(log, "Click on OK");
			driver.findElement(By.xpath("(//*[@class='timepicker-button'])[2]")).click();
			 ...
			 WebElement productatt= driver.findElement(By.xpath("//*[@ng-reflect-name='productAttributes']"));
			 productatt.click();
			 
			   List<WebElement> product = driver.findElements(By.tagName("mat-option"));
				 for(WebElement values:product)
				 {
				 ...
				 WebElement prodattval= driver.findElement(By.xpath("//*[@ng-reflect-name='productAttributesValue']"));
				 prodattval.click();
			...
			//store attribute dropdown
			 ...
			 Segmenttt.click();
				...
				//	driver.findElement(By.xpath("//input[@placeholder='Type Your Message']")).sendKeys("2");
