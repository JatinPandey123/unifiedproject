...
public class BasicPromo4 extends HelperClass{

	public void basicpromo4() throws Exception{
...
//		         String  = cell[i+5];
			...
			WebElement element6 = clickpromo.until(ExpectedConditions.visibilityOfElementLocated(
					By.xpath("//div[contains(text(),'Common Percentage Discount on Group of Products')]")));
			element6.click();
...
//	   		}
		...
		//	db.sysloginfo(log, "Click on OK");
			...
			//Product attribute
			 WebElement product= driver.findElement(By.xpath("//*[@ng-reflect-name='productAttributes']"));
			 product.click();
				    List<WebElement> productattr = driver.findElements(By.tagName("mat-option"));
					 for(WebElement values:productattr)
					 {
					 ...
					 WebElement Seg= driver.findElement(By.xpath("//*[@ng-reflect-name='productAttributesValue']"));
					 Seg.click();
			...
			//store attribute dropdown
			 ...
			 Segmenttt.click();
				...
				//	driver.findElement(By.xpath("//input[@id='invoiceTotalAmount']")).sendKeys("2");
					...
					driver.findElement(By.xpath("//input[@placeholder='Enter %']")).sendKeys("2");
