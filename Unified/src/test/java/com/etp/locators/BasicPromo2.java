...
public class BasicPromo2 extends HelperClass{

	//Percentage discount on bill total
	...
	public void basicpromo2() throws Exception {
	try {
...
//	         String  = cell[i+5];
		...
		WebElement element6 = clickpromo.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//div[contains(text(),'Percentage Discount on Bill Amount')]")));
		element6.click();
